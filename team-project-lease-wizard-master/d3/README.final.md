 ...
 * Since in Ontario’s highly regulated residential rental markets, landlords must comply with complex rules that are confusing to landlords and tenants alike. Unfortunately, the vast majority of leases are long documents written in legalese that:
 ...
 <!-- * Our project is an user-interactive web tool that helps landlords and tenants to fill out the Ontario Lease Form. -->
 ...
 * For more details, please visit https://lawdesigncolab.ca/portfolio/ontario-standard-lease-form-redesign/
 <!-- * Since a large amount of people are not familiar with laws and lease agreements, most leases are filled with terms that are ambiguous or poorly drafted, and this process itself is also complicated. In this way, our website provides a lot of information, choices and hints that helps user to fill the form, and then collect and extract the data to generate the formal Ontario Lease Form. -->
<!--
## Key Features
...
<!-- * Since MIT licensed projects can be freely distributed in a business friendly manner. We will allow partners distribute modifications to our code.  -->
